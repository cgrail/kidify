...
//  kidify
//
//  Created by Christian Grail on 02.11.17.
...
class BusyIndicator: NSObject {
    ...
    @discardableResult
    public static func customActivityIndicatory(_ viewContainer: UIView, startAnimate:Bool? = true) -> UIActivityIndicatorView {
